...
<p>
    <a href="<?php echo toy_e(toy_url('/admin/rewards/balances')); ?>">잔액</a>
    |
    <a href="<?php echo toy_e(toy_url('/admin/rewards/adjust')); ?>">조정</a>
    |
    <a href="<?php echo toy_e(toy_url('/admin/rewards/transactions')); ?>">거래 내역</a>
</p>
