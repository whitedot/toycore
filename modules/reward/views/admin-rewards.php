...
$adminPageTitle = '적립금 관리';
if ($rewardAdminPage === 'adjust') {
    $adminPageTitle = '적립금 조정';
} elseif ($rewardAdminPage === 'transactions') {
...
<section>
    <h2>회원 조회</h2>
    <form method="get" action="<?php echo sr_e(sr_url($rewardAdminPage === 'transactions' ? '/admin/rewards/transactions' : ($rewardAdminPage === 'adjust' ? '/admin/rewards/adjust' : '/admin/rewards/balances'))); ?>" class="admin-filter ui-form-theme">
...
<?php if ($rewardAdminPage === 'adjust') { ?>
    <form method="post" action="<?php echo sr_e(sr_url('/admin/rewards/adjust' . ($accountIdentifierFilter !== '' ? '?account_identifier=' . rawurlencode($accountIdentifierFilter) : ''))); ?>" class="admin-form ui-form-theme">
...
<?php } elseif ($rewardAdminPage === 'transactions') { ?>
            ...
            <table class="table">
                ...
                <tbody>
                    <?php foreach ($balances as $balance) { ?>
                        <tr>
                            <td><a href="<?php echo sr_e(sr_url('/admin/rewards/transactions?account_identifier=' . rawurlencode((string) $balance['account_public_hash']))); ?>"><?php echo sr_e((string) $balance['account_public_hash']); ?></a></td>
