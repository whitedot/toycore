...
<?php if ($depositAdminPage === 'adjust') { ?>
    <section>
        <h2>예치금 조정</h2>
        <form method="post" action="<?php echo toy_e(toy_url('/admin/deposits/adjust' . ($accountIdFilter > 0 ? '?account_id=' . (string) $accountIdFilter : ''))); ?>">
            ...
            <table>
                ...
                <tbody>
                    <?php foreach ($balances as $balance) { ?>
                        <tr>
                            <td><a href="<?php echo toy_e(toy_url('/admin/deposits/transactions?account_id=' . rawurlencode((string) $balance['account_id']))); ?>"><?php echo toy_e((string) $balance['account_id']); ?></a></td>
