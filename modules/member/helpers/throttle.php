...
{
    return ['password_change_reauth', 'password_change_session_failed', 'withdraw_reauth', 'privacy_export_reauth', 'module_source_reauth', 'module_setting_reauth', 'site_setting_reauth', 'privacy_request_export_reauth', 'reauth_blocked'];
}
